...
from hermes_jobctl.hermes_runner import build_create_args, build_edit_args
from hermes_jobctl.profile import build_cron_context
...
def test_build_cron_context_default():
    ...
    with patch("hermes_jobctl.profile.shutil.which", side_effect=fake_which):
